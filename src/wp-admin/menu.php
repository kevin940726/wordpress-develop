...
} else if ( current_theme_supports( 'block-template-parts' ) ) {
	$submenu['themes.php'][6] = array( _x( 'Patterns', 'site editor menu item' ), 'edit_theme_options', 'site-editor.php?path=/patterns' );
} else {
